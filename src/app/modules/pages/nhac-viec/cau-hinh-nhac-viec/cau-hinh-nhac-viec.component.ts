...
@Component({
  selector: 'app-cau-hinh-nhac-viec',
  templateUrl: './cau-hinh-nhac-viec.component.html',
  styleUrls: ['./cau-hinh-nhac-viec.component.css']
})
export class CauHinhNhacViecComponent {
