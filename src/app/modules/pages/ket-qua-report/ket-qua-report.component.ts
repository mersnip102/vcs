...
@Component({
  selector: 'app-ket-qua-report',
  templateUrl: './ket-qua-report.component.html',
  styleUrls: ['./ket-qua-report.component.css']
})
export class KetQuaReportComponent implements OnInit, OnDestroy {
  ...
  async ngOnInit() {
    await this.getAllDuAn();
    interval(10*60*1000).subscribe(async () => {
