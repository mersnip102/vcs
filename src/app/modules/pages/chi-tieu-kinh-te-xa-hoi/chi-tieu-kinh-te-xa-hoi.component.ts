...
@Component({
  selector: 'app-chi-tieu-kinh-te-xa-hoi',
  templateUrl: './chi-tieu-kinh-te-xa-hoi.component.html',
  styleUrls: ['./chi-tieu-kinh-te-xa-hoi.component.css']
})
export class ChiTieuKinhTeXaHoiComponent implements OnInit {
