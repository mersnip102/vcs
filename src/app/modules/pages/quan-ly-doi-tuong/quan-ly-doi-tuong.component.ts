...
@Component({
  selector: 'app-quan-ly-doi-tuong',
  templateUrl: './quan-ly-doi-tuong.component.html',
  styleUrls: ['./quan-ly-doi-tuong.component.css']
})
export class QuanLyDoiTuongComponent {
