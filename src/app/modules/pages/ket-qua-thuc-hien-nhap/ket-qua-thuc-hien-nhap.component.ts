...
@Component({
  selector: 'app-ket-qua-thuc-hien-nhap',
  templateUrl: './ket-qua-thuc-hien-nhap.component.html',
  styleUrls: ['./ket-qua-thuc-hien-nhap.component.css']
})
export class KetQuaThucHienNhapComponent {
